...
| Enrichissement Max · VARIÉTÉ de pratique : un exercice « Associe » par module guidé, dérivé des concepts réels et de leurs critères (213 → 223 exercices ; format `match` de 1 à 11) — colonne décalée pour que la solution ne soit jamais l'alignement ligne à ligne, solution vérifiée juste et bijective, et AUCUNE nouvelle exigence de maîtrise (variante de rotation d'un objectif déjà exerçable) (LOT E5) | [ADR-135](./ADR-135-trademy-lote5-match-variety.md) |
