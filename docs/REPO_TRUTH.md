...
| Compétences (modules guidés) | `ALL_MODULE_SKILLS` | 29 |
| Leçons | `allLessonsFlat()` | 40 |
| Exercices | `allExercisesFlat()` | 130 |
...
> Depuis le LOT 4-S, huit modules guidés existent (Fondations, Anatomie, Chandeliers, Structure,
> Niveaux, Figures, Indicateurs, Volume — les mondes 1-8 forment un préfixe entièrement guidé) :
> les compteurs agrègent TOUS les modules via `CONTENT_MODULES` (source unique).
