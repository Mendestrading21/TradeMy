...
| Compétences (modules guidés) | `ALL_MODULE_SKILLS` | 26 |
| Leçons | `allLessonsFlat()` | 37 |
| Exercices | `allExercisesFlat()` | 117 |
...
> Depuis le LOT 4-R, sept modules guidés existent (Fondations, Anatomie, Chandeliers, Structure,
> Niveaux, Figures, Indicateurs — les mondes 1-7 forment un préfixe entièrement guidé) : les
> compteurs agrègent TOUS les modules via `CONTENT_MODULES` (source unique).
