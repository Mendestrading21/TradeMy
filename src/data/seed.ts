...
const LESSONS: Record<string, Lesson[]> = {
  ...
  // ─── LOT G1 — La moyenne mobile et ses deux croisements ────────────
  'skill.indicators.moving-average': [
    {
      id: 'lesson.indicators-moving-average',
      slug: 'moyenne-mobile-lecture',
      title: 'La moyenne mobile : lisser coûte du temps',
      skillId: 'skill.indicators.moving-average',
      objective: 'Calculer une moyenne des dernières clôtures et voir ce que le lissage coûte.',
      difficulty: 'beginner',
      estimatedMinutes: 5,
      steps: [
        { id: 's0', kind: 'intro', body: 'C’est l’indicateur le plus employé de toute l’analyse technique, et le plus simple : la moyenne des N dernières clôtures, recalculée à chaque bougie.' },
        { id: 's1', kind: 'observe', body: 'Repère les deux lignes tracées SUR les bougies : la rapide (3 bougies) colle au prix, la lente (6 bougies) reste en retrait.' },
        { id: 's2', kind: 'visual', conceptRef: 'moyenne-mobile' },
        { id: 's3', kind: 'explain', body: 'Fais l’opération une fois : six clôtures qui montent de 40 à 50 donnent une ligne à 45. Le prix est à 50, la ligne à 45 — cinq points de retard, et ils viennent uniquement du calcul.' },
        { id: 'sMan', kind: 'interaction', conceptRef: 'moyenne-mobile' },
        { id: 's4', kind: 'falseSignal', body: 'Sur ce graphique hésitant, les deux moyennes se croisent puis se recroisent : deux croisements en treize bougies, sans tendance derrière. C’est le faux signal classique de la moyenne.' },
        { id: 's5', kind: 'summary', body: 'Moyenne mobile = résumé des N dernières clôtures. Elle enlève du bruit, elle n’ajoute aucune information — et plus elle est lisse, plus elle est lente.' },
        { id: 's6', kind: 'flashcard', flashcard: { front: 'Pourquoi une moyenne mobile est-elle toujours en retard ?', back: 'Parce qu’elle est faite des clôtures déjà passées : elle les résume, elle ne peut pas les devancer.' } },
      ],
      commonMistake: 'Attendre d’une moyenne qu’elle anticipe, alors qu’elle est construite pour retarder.',
      sources: ['Voix pédagogique Trademy'],
      status: 'draft',
    },
  ],
  'skill.indicators.cross-up': [
    {
      id: 'lesson.indicators-cross-up',
      slug: 'croisement-haussier-lecture',
      title: 'Le croisement haussier : un constat, pas une annonce',
      skillId: 'skill.indicators.cross-up',
      objective: 'Situer un croisement de moyennes par rapport au retournement du prix.',
      difficulty: 'intermediate',
      estimatedMinutes: 6,
      steps: [
        { id: 's0', kind: 'intro', body: 'La moyenne rapide repasse au-dessus de la lente. Le marché appelle ça un « golden cross » — le nom promet beaucoup, l’arithmétique promet moins.' },
        { id: 's1', kind: 'observe', body: 'Compte les bougies : le prix touche son plus bas à la quatrième, les moyennes ne se croisent qu’à la septième.' },
        { id: 's2', kind: 'visual', conceptRef: 'croisement-haussier-de-moyennes' },
        { id: 's3', kind: 'hypothesis', conceptRef: 'croisement-haussier-de-moyennes', body: 'Trois bougies séparent le retournement du constat. Le croisement ne déclenche rien : il enregistre que les clôtures ont assez remonté pour tirer la courte au-dessus de la longue.' },
        { id: 'sMan', kind: 'interaction', conceptRef: 'croisement-haussier-de-moyennes' },
        { id: 's4', kind: 'explain', body: 'La confirmation vient d’après : des plus-bas qui tiennent, un plus-haut repris. L’invalidation est un plancher — sous le plus bas de la jambe, la rapide repasse sous la lente.' },
        { id: 's5', kind: 'falseSignal', body: 'En range, ce croisement se produit dans les deux sens à répétition, sans qu’aucune tendance suive.' },
        { id: 's6', kind: 'summary', body: 'Croisement haussier = la courte franchit la longue par le bas, APRÈS le retournement du prix. Un constat en retard, à confirmer par la structure.' },
        { id: 's7', kind: 'flashcard', flashcard: { front: 'Le croisement haussier arrive-t-il avant ou après le retournement du prix ?', back: 'Après — toujours. Sur le graphique de la fiche, trois bougies après le plus bas.' } },
      ],
      commonMistake: 'Croire que le croisement annonce la hausse, alors qu’il la constate.',
      sources: ['Voix pédagogique Trademy'],
      status: 'draft',
    },
  ],
  'skill.indicators.cross-down': [
    {
      id: 'lesson.indicators-cross-down',
      slug: 'croisement-baissier-lecture',
      title: 'Le croisement baissier : le même calcul, un autre nom',
      skillId: 'skill.indicators.cross-down',
      objective: 'Lire le miroir du croisement haussier — plafond d’invalidation compris.',
      difficulty: 'intermediate',
      estimatedMinutes: 6,
      steps: [
        { id: 's0', kind: 'intro', body: 'La moyenne rapide repasse sous la lente. On l’appelle « death cross » : le nom le plus dramatique de l’analyse technique, pour le même calcul qu’au LOT précédent, au sens près.' },
        { id: 's1', kind: 'observe', body: 'Compte encore les bougies : le sommet du prix tombe à la quatrième, le croisement à la septième. Trois bougies, là aussi.' },
        { id: 's2', kind: 'visual', conceptRef: 'croisement-baissier-de-moyennes' },
        { id: 's3', kind: 'hypothesis', conceptRef: 'croisement-baissier-de-moyennes', body: 'Un nom dramatique n’est pas une mesure : la portée d’une figure ne se lit pas dans son surnom.' },
        { id: 'sMan', kind: 'interaction', conceptRef: 'croisement-baissier-de-moyennes' },
        { id: 's4', kind: 'explain', body: 'Ici l’invalidation change de côté : elle est un PLAFOND. Au-dessus du plus haut de la jambe, la rapide repasse au-dessus de la lente et le constat tombe.' },
        { id: 's5', kind: 'falseSignal', body: 'Poser un plancher sous un setup baissier est l’erreur symétrique la plus fréquente : le niveau qui compte est au-dessus.' },
        { id: 's6', kind: 'summary', body: 'Croisement baissier = la courte franchit la longue par le haut, après le sommet. Invalidation au-dessus, confirmation par la structure.' },
        { id: 's7', kind: 'flashcard', flashcard: { front: 'Où se pose l’invalidation d’un croisement baissier ?', back: 'Au-dessus : c’est un plafond, le plus haut de la jambe qui a produit le croisement.' } },
      ],
      commonMistake: 'Oublier que l’invalidation d’un scénario baissier est un plafond, pas un plancher.',
      sources: ['Voix pédagogique Trademy'],
      status: 'draft',
    },
  ],
  // ─── LOT G2 — L'amplitude moyenne et les retracements ──────────────
  'skill.indicators.atr': [
    {
      id: 'lesson.indicators-atr',
      slug: 'atr-lecture',
      title: 'L’ATR : combien ça bouge, pas dans quel sens',
      skillId: 'skill.indicators.atr',
      objective: 'Lire une amplitude moyenne en unités de prix et la convertir en distance.',
      difficulty: 'intermediate',
      estimatedMinutes: 6,
      steps: [
        { id: 's0', kind: 'intro', body: 'Tous les indicateurs vus jusqu’ici répondent à « comment va le marché ». Celui-ci répond à une autre question : de combien il bouge — en euros, en points, dans la même unité que le prix.' },
        { id: 's1', kind: 'observe', body: 'Regarde les bougies s’élargir, puis se resserrer. La courbe du dessous suit, mais avec du retard : elle culmine UNE bougie après la plus large.' },
        { id: 's2', kind: 'visual', conceptRef: 'atr' },
        { id: 's3', kind: 'explain', body: 'Et elle culmine plus bas que la bougie la plus large ne mesurait : c’est une moyenne, les bougies calmes la tirent vers le bas. Une moyenne ne rend jamais l’extrême.' },
        { id: 'sMan', kind: 'interaction', conceptRef: 'atr' },
        { id: 's4', kind: 'falseSignal', body: 'Un ATR qui grimpe ne dit rien du sens : une chute violente le fait monter exactement comme une hausse violente. Le piège est de lire une accélération comme une direction.' },
        { id: 's5', kind: 'summary', body: 'ATR = amplitude moyenne, dans l’unité du prix. Il sert à poser une distance — une invalidation, par exemple — jamais à annoncer un sens.' },
        { id: 's6', kind: 'flashcard', flashcard: { front: 'Un ATR qui monte annonce-t-il une hausse ?', back: 'Non : il ignore le sens. Une baisse brutale le fait monter exactement pareil.' } },
      ],
      commonMistake: 'Poser une invalidation en pourcentage fixe alors que l’amplitude du moment a doublé.',
      sources: ['Voix pédagogique Trademy'],
      status: 'draft',
    },
  ],
  'skill.indicators.fibonacci': [
    {
      id: 'lesson.indicators-fibonacci',
      slug: 'retracements-lecture',
      title: 'Les retracements : des niveaux choisis, pas trouvés',
      skillId: 'skill.indicators.fibonacci',
      objective: 'Lire une grille de retracement et savoir de quoi elle dépend.',
      difficulty: 'advanced',
      estimatedMinutes: 7,
      steps: [
        { id: 's0', kind: 'intro', body: 'Après une impulsion, le prix revient souvent sur une partie du chemin. La grille découpe ce chemin en fractions et propose des niveaux où le repli pourrait ralentir.' },
        { id: 's1', kind: 'observe', body: 'Le mouvement va de 43,40 à 62,60. Le niveau 50 % tombe à 53,00 — et le repli s’arrête à 53,40. Quatre dixièmes au-dessus.' },
        { id: 's2', kind: 'visual', conceptRef: 'retracements-de-fibonacci' },
        { id: 's3', kind: 'hypothesis', conceptRef: 'retracements-de-fibonacci', body: 'Assez près pour parler de « respect du niveau », assez loin pour se demander ce que « près » veut dire. C’est toute la difficulté de cet outil.' },
        { id: 'sMan', kind: 'interaction', conceptRef: 'retracements-de-fibonacci' },
        { id: 's4', kind: 'explain', body: 'Les ratios sont fixes, mais les niveaux ne le sont pas : ils dépendent des DEUX points choisis. Change les points, tous les niveaux bougent. Et le 50 % n’est même pas un ratio de Fibonacci — il est là par convention.' },
        { id: 's5', kind: 'falseSignal', body: 'Redessiner la grille jusqu’à ce qu’un niveau tombe pile sur le creux : à ce jeu-là, elle marche toujours. C’est le faux signal le plus courant de l’outil, parce qu’il se fabrique après coup.' },
        { id: 's6', kind: 'summary', body: 'Un niveau est une zone d’attention. Ce qui confirme, c’est la structure du prix dedans ; ce qui efface tout, c’est une clôture sous le départ du mouvement.' },
        { id: 's7', kind: 'flashcard', flashcard: { front: 'Le niveau 50 % est-il un ratio de Fibonacci ?', back: 'Non. Il est là par convention : un repli de moitié se remarque, c’est tout.' } },
      ],
      commonMistake: 'Tracer la grille sur un mouvement dont on n’a pas identifié les extrémités.',
      sources: ['Voix pédagogique Trademy'],
      status: 'draft',
    },
  ],
  // ─── LOT G3 — Le stochastique et la divergence cachée ──────────────
  'skill.indicators.stochastic': [
    {
      id: 'lesson.indicators-stochastic',
      slug: 'stochastique-lecture',
      title: 'Le stochastique : le sosie du RSI',
      skillId: 'skill.indicators.stochastic',
      objective: 'Distinguer deux oscillateurs 0-100 qui ne mesurent pas la même chose.',
      difficulty: 'advanced',
      estimatedMinutes: 6,
      steps: [
        { id: 's0', kind: 'intro', body: 'Une courbe de 0 à 100, sous le prix, avec des zones extrêmes. On croit reconnaître le RSI. On se trompe.' },
        { id: 's1', kind: 'observe', body: 'Premier indice à l’œil : les zones sont à 80 et 20, pas à 70 et 30.' },
        { id: 's2', kind: 'visual', conceptRef: 'stochastique' },
        { id: 's3', kind: 'explain', body: 'Le stochastique répond à une autre question : où se situe la clôture DANS le range des dernières bougies ? En haut, 100 ; en bas, 0. Le RSI, lui, compare l’ampleur des hausses à celle des baisses.' },
        { id: 'sMan', kind: 'interaction', conceptRef: 'stochastique' },
        { id: 's4', kind: 'hypothesis', conceptRef: 'stochastique', body: 'Deux questions différentes donnent deux réponses différentes : sur cette série, à la douzième bougie, le stochastique affiche 4 et le RSI 32. Aucun des deux n’a tort.' },
        { id: 's5', kind: 'falseSignal', body: 'Le piège est de transposer les seuils : traiter le 20 du stochastique comme le 30 du RSI. Et en tendance franche, la saturation est normale, pas exceptionnelle.' },
        { id: 's6', kind: 'summary', body: 'Stochastique = position de la clôture dans un range, zones 80/20. RSI = force relative des hausses et des baisses, zones 70/30. Même échelle, mesures différentes.' },
        { id: 's7', kind: 'flashcard', flashcard: { front: 'Que mesure le stochastique, exactement ?', back: 'La position de la clôture dans le range des N dernières bougies : en haut, %K vaut 100 ; en bas, 0.' } },
      ],
      commonMistake: 'Lire un stochastique comme un RSI parce que les deux vont de 0 à 100.',
      sources: ['Voix pédagogique Trademy'],
      status: 'draft',
    },
  ],
  'skill.indicators.hidden-divergence': [
    {
      id: 'lesson.indicators-hidden-divergence',
      slug: 'divergence-cachee-lecture',
      title: 'La divergence cachée : le même désaccord, l’autre conclusion',
      skillId: 'skill.indicators.hidden-divergence',
      objective: 'Lire un désaccord sur des CREUX comme une continuation, non un essoufflement.',
      difficulty: 'advanced',
      estimatedMinutes: 7,
      steps: [
        { id: 's0', kind: 'intro', body: 'Le prix et l’oscillateur se contredisent, comme dans une divergence classique. Et pourtant la conclusion s’inverse.' },
        { id: 's1', kind: 'observe', body: 'Regarde CE qui est comparé : deux creux, pas deux sommets. Celui du prix passe de 47 à 51 — il monte. Celui de l’oscillateur passe de 30 à 25 — il descend.' },
        { id: 's2', kind: 'visual', conceptRef: 'divergence-cachee' },
        { id: 's3', kind: 'explain', body: 'Un creux plus haut, c’est une structure haussière qui tient. Le désaccord de l’oscillateur ne l’annule pas : il accompagne une pause. D’où la lecture de continuation.' },
        { id: 'sMan', kind: 'interaction', conceptRef: 'divergence-cachee' },
        { id: 's4', kind: 'falseSignal', body: 'L’erreur la plus fréquente sur cette figure est de lui appliquer la conclusion de l’autre : annoncer un retournement. C’est exactement l’inverse de ce qu’elle dit.' },
        { id: 's5', kind: 'summary', body: 'Sommets qui divergent = essoufflement. Creux qui divergent, avec un creux du prix plus haut = continuation. La question à se poser tient en trois mots : creux ou sommets ?' },
        { id: 's6', kind: 'flashcard', flashcard: { front: 'Quelle est la différence entre divergence classique et divergence cachée ?', back: 'La classique compare des sommets et signale un essoufflement ; la cachée compare des creux et signale une continuation.' } },
      ],
      commonMistake: 'Comparer des sommets en croyant comparer des creux.',
      sources: ['Voix pédagogique Trademy'],
      status: 'draft',
    },
  ],
...
const RAW_EXERCISES: Record<string, Exercise[]> = {
  ...
  'skill.indicators.moving-average': INDICATORS_MODULE_EXERCISES_BY_SKILL['skill.indicators.moving-average'],
  'skill.indicators.cross-up': INDICATORS_MODULE_EXERCISES_BY_SKILL['skill.indicators.cross-up'],
  'skill.indicators.cross-down': INDICATORS_MODULE_EXERCISES_BY_SKILL['skill.indicators.cross-down'],
  'skill.indicators.atr': INDICATORS_MODULE_EXERCISES_BY_SKILL['skill.indicators.atr'],
  'skill.indicators.fibonacci': INDICATORS_MODULE_EXERCISES_BY_SKILL['skill.indicators.fibonacci'],
  'skill.indicators.stochastic': INDICATORS_MODULE_EXERCISES_BY_SKILL['skill.indicators.stochastic'],
  'skill.indicators.hidden-divergence': INDICATORS_MODULE_EXERCISES_BY_SKILL['skill.indicators.hidden-divergence'],
